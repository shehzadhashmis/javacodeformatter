...
public class 
EclipseCodeFormatterApplication {
    ...
    {
        log.info("Inside EclipseCodeFormatterApplication.callMethodWithMultipleArguments method with title:{}, firstName:{}, lastName:{}, phoneNumber:{}, email:{}, description:{}", title, firstName, lastName, phoneNumber, email, description);
    }
