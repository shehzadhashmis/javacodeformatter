...
/**
 * A Spring Boot application class to demonstrate Java code formatting with google style
 * formatting.
 *
...
public class
GoogleCodeFormatterApplication 
{
  ...
  {
    log.info("Inside GoogleCodeFormatterApplication.callMethodWithMultipleArguments method with title:{}, firstName:{}, lastName:{}, phoneNumber:{}, email:{}, description:{}", title, firstName, lastName, phoneNumber, email, description);
  }
}
